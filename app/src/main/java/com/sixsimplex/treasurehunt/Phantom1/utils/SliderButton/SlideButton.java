package com.sixsimplex.treasurehunt.Phantom1.utils.SliderButton;
...
public class SlideButton extends FrameLayout {
    ...
    public void init(@Nullable AttributeSet set){
        ...
        LayoutParams childParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
