...
public class HorizontalDotProgressBar extends View {
    //actual dot radius
    ...
    public HorizontalDotProgressBar(Context context) {
        super(context);
    }

    public HorizontalDotProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HorizontalDotProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
